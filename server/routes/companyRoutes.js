...
router.get('/', function (req, res) {
    connection.query(`select distinct cusip,name,period_of_report,shares, count(cusip) as stockCount from aggregate_holdings where period_of_report = "Q3-21" group by cusip`, 
